...
# добавить меню с выбором игра с ботом, онлайн, локальная игра, не переворачивать игру после хода в игре против бота и в игре онлайн, блокировать ввод, когда ход не твой, обрабатывать сетевые события. 
import pygame
import sys
import os
